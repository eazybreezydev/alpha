      ...
      content: Column(
        ...
        children: [
          ListTile(
            ...
            subtitle: const Text('Connect Samsung SmartThings devices'),
            onTap: () {
              Navigator.of(context).pop();
          ...
          ListTile(
            ...
            subtitle: const Text('Connect Google Home devices'),
            onTap: () {
              Navigator.of(context).pop();
              smartHomeProvider.connectProvider(context, 'googlehome');
            },
          ),
        ],
      ),
